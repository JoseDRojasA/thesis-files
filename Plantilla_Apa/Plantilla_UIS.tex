...
% ------------------------------------------------------------------------
\title{Definición de una infraestructura cloud para el despliegue de una plataforma IoT}
% ------------------------------------------------------------------------
% Elementos previos al contenido del trabajo
% ------------------------------------------------------------------------
\include{Secs/P0}             % Portadilla, formato de nota y autorización
% ------------------------------------------------------------------------
...
\include{Secs/T2}   % Estado del arte
\input{Secs/T3}   	% Marco de referencia
\input{Secs/T4}   	% Marco técnico
\input{Secs/T5}   	% Desarrollo del proyecto
\input{Secs/T6}   	% Conclusiones
\input{Secs/T7}   	% Recomendaciones
