...
En la infraestructura se desplegaron 2 instancias del frontend y 3 instancias del backend. Durante la prueba se monitorio el uso de recursos en los servidores. Durante una fase de la prueba se apago uno de los nodos y el sistema continuó funcionando con normalidad, se pudo evidenciar como el sistema levanta instancias en el nodo restante con el fin de mantener consiste la cantidad de instancias presentes en la infraestructura lo cual permitió ver la alta disponibilidad que provee la infraestructura a la plataforma IoT.
