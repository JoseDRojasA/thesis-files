...
% ------------------------------------------------------------------------.
\noindent En este capítulo se abordaran las tecnologías usadas durante el proyecto para implementar los conceptos abordados en el Capítulo 3.
% ------------------------------------------------------------------------
% ------------------------------------------------------------------------
% ------------------------------------------------------------------------
...
\begin{itemize}
	...
	\item\textbf{Imagen:} Template que describe el estado inicial de un contenedor. Una imagen puede ser construida a partir de otra imagen disponible en un registro remoto. Haciendo una analogía con al programación orientada a objetos, una imagen es una clase que puede ser instanciada n veces en forma de contenedor.
	\item\textbf{Registro:} Es un repositorio de imágenes. Puede ser público o privado, es decir que es posible trabajar con imágenes disponibles en internet. Uno de los registros públicos mas populares es Docker Hub, el cual pertenece a Docker Inc.
\end{itemize}
...
\begin{itemize}
	\item Que aplicaciones se encuentran en ejecución.
...
\begin{itemize}
	...
	\item \textbf{Service:} Interfase entre cliente y la aplicación dentro de los pods. Es una pareja ip-puerto estática que se encarga de redirigir las solicitudes entre los diferentes pods disponibles.
...
\section{Openshift}
Openshift es un PaaS ofrecido por Red Hat con una integración nativa con Docker y Kubernetes, añadiendo funcionalidades de las cuales Kubernetes carece como:
\begin{itemize}
...
En la arquitectura de Ansible, se tiene un archivo YAML, llamado Inventory, en el cual se describen los diferentes elementos de la infraestructura TI y variables de configuración. Posteriormente se ejecutan los playbooks usando el Inventory y Ansible indica si el proceso fue ejecutado con exito o hubo algún problema durante alguno de los pasos del playbook.
